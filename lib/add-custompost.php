...
//new add_custompost('postname','表示名',array(array('tax','タクソノミ―名',TRUE,,TRUE)),FALSE,FALSE,FALSE,'');

new add_custompost(
    'postname',
    '投稿【カスタム】',
    array(
        array('cate01','カテゴリー01',true,true),
        array('cate02','カテゴリー02',true,true),
        array('cate03','カテゴリー03',true,true),
        // array('cate04','カテゴリー04',true,true),
    ),
    false,
    true,
    false,
